...
Source0  : https://www.x.org/releases/individual/xserver/xorg-server-21.1.5.tar.gz
Source1  : https://www.x.org/releases/individual/xserver/xorg-server-21.1.5.tar.gz.sig
...
%prep
%setup -q -n xorg-server-21.1.5
cd %{_builddir}/xorg-server-21.1.5
%patch1 -p1
pushd ..
cp -a xorg-server-21.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671061804
